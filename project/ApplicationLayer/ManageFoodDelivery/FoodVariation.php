...
<body bgcolor="#ffcccc">
  ...
  <table id="detail" width="100%" height="70%" align="center">
    ...
    <tr align="center" style="height: 90%"> <hr>
      ...
      <td><button type="submit" name="variation" value="Chips" style="width: 120px;height: 120px"> Potato Chips & Crisps <br> <br> <img src="../../images/GUIImages/snacks.png" style="width:50px;height:50px;border:0"/>  </button></td>
