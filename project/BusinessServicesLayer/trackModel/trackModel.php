...
class trackModel{
    ...
    function food_rpt(){
        $sql = "select count(product_id) as sum, product_name, product_price, sum(product_quantity) as quantity from ordered where sp_id=:sp_id and product_type=:product_type group by product_name";
