        ...
        if($datano == 0){
            ...
            foreach($data as $row){
                ...
                $output .= '
                    ...
                    <td style="padding: 5px;"><button type="button" id="seeProduct_btn" style="width: 190px;height: 270px;border:transparent;" onclick=\'location.href='.$location.'\'><img src='.$image_src.' style="width:160px;height:140px;padding-left:5px;padding-right:7px;"> <br><br> '.$row['gd_name'].' <br><br> RM '.$row['gd_price'].' <br><br> '.$row['sp_name'].' </button></td>';
