...
<body bgcolor="#ffffe6">
  ...
  <table id="detail" width="100%" height="80%">
    ...
    <tr bgcolor="#e1e1ea">
      <td align="center" colspan="2" width="50%"> BECOME A RUNNER <br> <br> <input type="button" onclick="window.location.href='RunnerSignup.php'" value="Sign Up AS RUNNER"></td>
      <td align="center" colspan="2"> BECOME A SERVICE PROVIDER <br> <br> <input type="button" onclick="window.location.href='SPSignup.php'" value="Sign Up AS SERVICE PROVIDER"> </td>
    </tr>
  </table>
